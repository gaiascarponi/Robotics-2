...
% A_consec = here I stored each transformation of the sequence in 
%       another cell array(so you have A_01, A_12,...,A_n-1n)
%       CONSECUTIVE!!
% "ROTATION MATRIX"                                   ---> 0R1(q1),..,nRm(qm)   ---> prendi (1:3,1:3).    
% "POSITION VECTOR BETWEEN ORIGIN IN PREVIOUS FRAMES" ---> 0r01(q1),..,nrnm(qm) ---> prendi (1:3,4).
% "POSITION VECTOR BETWEEN ORIGIN IN MOVING FRAMES"   ---> 1r01,..,mrnm         ---> prendi - inv(A_consec{1})
